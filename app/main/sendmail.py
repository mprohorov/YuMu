...
def send(pn1, pn2, pn3):
    ...
    s.sendmail('YuMu', (pn3 + '@vtext.com'), 'This is a message to let you know THE TEXT BOT WORKS, BABY!')
    s.sendmail('YuMu', (pn3 + '@mms.att.net'), 'This is a message to let you know THE TEXT BOT WORKS, BABY!')
    s.sendmail('YuMu', (pn3 + '@tmomail.net'), 'This is a message to let you know THE TEXT BOT WORKS, BABY!')
    s.sendmail('YuMu', (pn3 + '@page.nextel.com'), 'This is a message to let you know THE TEXT BOT WORKS, BABY!')
    s.quit()
